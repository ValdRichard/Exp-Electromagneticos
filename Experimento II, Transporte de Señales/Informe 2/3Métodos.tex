...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        ...
        \caption{Configuración utilizada para obtener la constante de tiempo, donde para una frecuencia constantese midió cada nodo y para frecuencia variable se fijó el nodo 6.}
    ...
    \begin{subfigure}[b]{0.40\linewidth}
        ...
        \caption{Configuración utilizada para obtener la impedancia del circuito, donde se midió la diferencia de potencial entre la fuente y la resistencia en el primer nodo.}
