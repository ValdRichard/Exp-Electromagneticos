...
Por otro lado, al igual que el circuito RC, el circuito RLC también es un sistema LIT, por lo que existirá una función de transferencia que caracteriza la señal de salida en función de la frecuencia de la señal de entrada. En este caso, el circuito funciona como un filtro selectivo de frecuencias cercanas a la frecuencia de resonancia del sistema \(\omega_r\). De esta manera, el módulo de la función de transferencia del circuito RLC se expresa como \cite{oppenheim1997signals}
    ...
    Con el objetivo de determinar las constantes características de ambos circuitos y analizar su respuesta en frecuencia, se construyeron diagramas de Bode y Nyquist a partir de medidas de tensión de entrada y salida, junto al desfasajeentre ambas señales.