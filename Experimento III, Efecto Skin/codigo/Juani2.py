...
f = np.array([
    20.21, 40.139, 60.367, 80.178, 100.07,
    120, 140, 160, 180, 200,
    300, 400, 500, 600, 700,
    800, 900
])
...
t = np.array([
    0.0086, 0.0032, 0.0018, 0.00128, 0.00088,
    0.0006, 0.0004, 0.00032, 0.00026, 0.00018,
    0.00010, 0.00006, 0.00004, 0.00003, 0.00002,
    0.000008, 0.000004
])

dt = np.array([
    0.0001,   0.0001,   0.0001,   0.00001,  0.00001,
...
v_p = np.array([
    0.179, 0.136, 0.116, 0.105, 0.0958,
    0.0884, 0.0818, 0.0758, 0.0704, 0.066,
    0.0495, 0.0392, 0.0323, 0.0275, 0.0239,
    0.0211, 0.0186
])
...
v_s = np.array([
    4.95, 5.74, 5.72, 5.53, 5.27,
    4.99, 4.71, 4.42, 4.17, 3.93,
    3.06, 2.46, 2.06, 1.77, 1.55,
    1.38, 1.24
])
