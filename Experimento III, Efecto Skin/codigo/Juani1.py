...
f = np.array([
    20, 30.084, 40.178, 50.085, 60.06, 70.026, 80.036,
    90.068, 100, 200, 300, 400, 500, 600, 700
])
...
t = np.array([
    0.0084, 0.0052, 0.0031, 0.0023, 0.0017,
    0.0012, 0.0009, 0.0008, 0.0006, 0.0002,
    0.00012, 0.00006, 0.00004, 0.000032, 0.00002
])

dt = np.array([
    0.0001, 0.0001, 0.0001, 0.0001, 0.0001,
    0.0001, 0.0001, 0.0001, 0.0001, 0.0001,
    0.00001, 0.00001, 0.00001, 0.000001, 0.00001
])

v_p = np.array([
    0.182, 0.155, 0.138, 0.126, 0.118,
    0.111, 0.105, 0.101, 0.0962, 0.067,
    0.0497, 0.0393, 0.0325, 0.0275, 0.0236
])
...
v_s = np.array([
    5.02, 5.6, 5.79, 5.82, 5.76,
    5.67, 5.57, 5.43, 5.28, 3.96,
    3.06, 2.47, 2.06, 1.77, 1.50
])
