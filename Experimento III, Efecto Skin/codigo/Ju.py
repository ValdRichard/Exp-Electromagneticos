...
t = np.array([
    0.0037, 0.0022, 0.00136, 0.00132,
    0.00098, 0.00074, 0.00050, 0.00047,
    0.00040, 0.00028, 0.00024, 0.00018,
    0.000148, 0.00010, 0.000058,
    0.000032, 0.000024, 0.000020
])
...
v_p = np.array([
    7.86e-5, 6.88e-5, 6.31e-5, 5.87e-5,
    5.52e-5, 5.24e-5, 5.00e-5, 4.76e-5,
    4.23e-5, 3.77e-5, 3.40e-5, 3.27e-5,
    2.80e-5, 2.43e-5, 1.90e-5,
    1.58e-5, 1.33e-5, 1.17e-5
])

dv_p = np.full(len(f), 1e-6)
