...
dv_p = np.array([0.02661, 0.013742, 0.007935, 0.02076, 0.007182, 0.003957, 0.003813,
                 0.002522, 0.002441, 0.002236, 0.0022793, 0.02667, 0.01487, 0.01424, 0.003633])
dv_s = np.array([0.6561, 0.6546, 0.6177, 0.291, 0.2745, 0.2625, 0.2538,
                 0.0849, 0.08061, 0.07494, 0.07017, 0.6528, 0.6786, 0.6705, 0.1604])
df   = np.array([1.055, 6.07, 10.94, 15.99, 21.01, 26.065, 31.415,
                 50.95, 61.2, 75.3, 95.65, 1, 2.4975, 4.0325, 40.985])
dt   = np.array([0.005, 0.001, 0.0005, 0.0005, 0.00025, 0.00025, 0.0001,
                 0.0001, 0.00005, 0.00005, 0.00005, 0.0025, 0.001, 0.001, 0.0001]) / 5
...
dv_p = np.array([0.013742, 0.007935, 0.02076, 0.007182, 0.003957, 0.003813,
                 0.002522, 0.002441, 0.002236, 0.0022793, 0.01424, 0.003633, 0.01487])
dv_s = np.array([0.6546, 0.6177, 0.291, 0.2745, 0.2625, 0.2538,
                 0.0849, 0.08061, 0.07494, 0.07017, 0.6705, 0.1604, 0.6786])
df   = np.array([6.07, 10.94, 15.99, 21.01, 26.065, 31.415,
                 50.95, 61.2, 75.3, 95.65, 4.0325, 40.985, 2.4975])
dt   = np.array([0.001, 0.0005, 0.0005, 0.00025, 0.00025, 0.0001,
                 0.0001, 0.00005, 0.00005, 0.00005, 0.001, 0.0001, 0.001]) / 5
