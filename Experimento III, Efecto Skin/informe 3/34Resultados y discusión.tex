...
\begin{figure} [H]
    ...
    \caption{Comparación entre los datos experimentales y su curva de ajuste (en rojo) y la respuesta teórica esperada para el sistema (en violeta).}
